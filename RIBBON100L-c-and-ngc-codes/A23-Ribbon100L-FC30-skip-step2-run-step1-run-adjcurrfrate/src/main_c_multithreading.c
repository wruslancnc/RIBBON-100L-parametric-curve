...
char CurveType[10] = "A23-RB100L";
char CurveTypeDesc[80]
  = "RIBBON-100L ALGO=23 SKIP STEP2 RUN-STEP1 RUN-ADJFR FRATECMD=30";
  ...
  while (!loop_u_done)
    {
      ...
      fprintf (FHdata_01,
               ...
               "%7.3lf %.12e %10.6lf %10.6lf %10.6lf %10.6lf %12.9lf %10.6lf "
               "%10.6lf %6.2lf",
               rtime, u, u_next, t_interpol, curr_unext1stOrder,
               curr_unext2ndOrder, (curr_unext1stOrder - curr_unext2ndOrder),
               fxn_cpos_x (u), fxn_cpos_y (u), fxn_cpos_r (u), curr_eps,
      ...
      */
      ...
      /* START BYPASS STEP 2
                ...
                step2_unext = fxn_get_u_next_with_eps_both_bounded (
                  u, u_next, uppertol_bound, lowertol_bound,
         &count_step2_ERROR_1, &count_step2_ERROR_2, &count_step2_ERROR_3,
         &count_step2_ERROR_4);
              ...
              {
                printf (
                  "ERROR IN MAIN: COUNTING EPS POINTS step2_unext
         CALCULATION.\n"); count_error_step2 += 1;
              }
      */ // END BYPASS STEP 2

      // ********************************************
      // ALWAYS GURANTEE u MOVES FORWARD (ALWAYS POSITIVE - use fabs())
